...
// =========================== MENU SHOW =====================
/* VAlisate if the constant exists */
if(navToggle){
...
function scrollUp(){
    ...
    // when the scroll higher than 560 viewpoint /height , then the scroll up icon showlf appear and on clicking should reach top the page
    if(this.scrollY >= 560) {
